...
if (isset($_SESSION['staff'])) {
    $id = $_SESSION['staff'];
    $sel = mysqli_query($con, "select * from tbl_staff where login_id=$id");
...
.rounded {
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Add complaint</label>
    <textarea type="text"  name="complaint" class="form-control" id="exampleInputPassword1"></textarea>
  </div>
  <input type="hidden" name="sid" value="<?php echo $t['s_id']?>">
