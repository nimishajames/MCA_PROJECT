                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <?php
                            $outpass = mysqli_query($con, "select * from tbl_outpass o ,tbl_hosteller h where h.host_id=$t[host_id] and o.host_id=$t[host_id]" );
                                ...
                                <table class=" table">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <th><?php if ($r['status'] == 0) {
                                                    echo '<span class="text-warning">Pending<span>';
                                                } else if ($r['status'] == 1) {
                                                    echo '<a class="btn btn-success" href="viewprintoutpass.php?hid='.$r['host_id'].'&Oid='.$r['O_id'].'">View</a>';
                                                } else {
