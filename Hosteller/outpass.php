...
?>
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="card" style="padding:25px;border-radius:25px;">
                                        ...
                                        <form action="outpass.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress2">Date of Leaving</label>
                                                <input type="Date" class="form-control" name="Ldate" id="time" placeholder="time">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputAddress">Date of Arrival</label>
                                                <input type="Date" class="form-control" name="adate" id="date" placeholder="avdate">
                                            </div>

                                            <input type="hidden" name="hid" value="<?php echo $t['host_id']; ?>">
                                            <div class="form-group">
                                                <label for="inputAddress">.</label>
                                                <button type="submit" name="submit" class="btn btn-primary">Apply For Outpass</button>
                                            </div>
    ...
    <?php
        ...
        if (mysqli_query($con, "INSERT INTO  tbl_outpass( O_place, O_purpose, OL_date, OR_date, host_id,status) VALUES ('$place','$purpose','$Ldate','$Adate','$hostid','0')")) {
            if (headers_sent()) {
                die('<script type="text/javascript">window.location.href="outpass.php?e=1"</script>');
            } else {
                header("location:outpass.php?e=1");
                die();
            }
        }
    }
