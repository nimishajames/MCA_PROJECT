                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                ...
                                <?php
                                $be=mysqli_query($con,"select * from tbl_roomtype rt,tbl_hosteller h,tbl_rmrequest rm where rt.roomtype_id=rm.roomtype_id and h.host_id=rm.host_id and rm_status=0");
                                while($rq=mysqli_fetch_array($be))
{ ?><tr>
                                <th> <?php echo $rq['host_name'];?></th>
                                <th> <?php echo $rq['host_email'];?></th>
                                <th> <?php echo $rq['host_phone'];?></th>
                                <th> <?php echo $rq['roomtype'];?></th>
                                <th ><a class="btn btn-success" href="allo.php?hid=<?php echo $rq['host_id'];?>&rid=<?php echo $rq['roomtype_id'];?>&rmid=<?php echo $rq['rm_id'];?>">Accept</a></th>
                                <th ><a class="btn btn-danger" href="reject.php?hid=<?php echo $rq['host_id'];?>&rid=<?php echo $rq['roomtype_id'];?>">Reject</a></th>
    </tr><?php } ?>
                                </table>
                                </div>       
        </div>
