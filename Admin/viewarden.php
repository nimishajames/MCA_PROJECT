                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <table class="table">
                                    ...
                                    <?php
                                    $sa = mysqli_query($con, "select * from tbl_warden");
                                    ...
                                    ?>
                                        <tbody>
                                            <tr>
                                                <th><?php echo $t['w_name']; ?></th>
                                                <th><?php echo $t['w_address']; ?></th>
                                                <th><?php echo $t['w_phone']; ?></th>
                                                <th><?php echo $diff->format('%y'); ?></th>
                                                <th><?php echo $t['w_email']; ?></th>
                                                <th><a class="btn btn-danger" href="wardendsable.php?wid=<?php echo $t['w_id']; ?>"><?php if ($t1['status'] == 0) {
                                                                                                                                        echo "Activate";
                                                                                                                                    } else {
                                                                                                                                        echo "De-activate";
                                                                                                                                    } ?></a></th>
