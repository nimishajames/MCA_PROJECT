               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <div class="card">
                        <table class="table">
                           <tr>
                              <td>Sneha Nilya Ladies Hostel</td>
                           </tr>
                           <?php
                           $sa = mysqli_query($con, "select * from  tbl_hostelfee");
                           $t = mysqli_fetch_array($sa);
                           ?>
                           <form action="fees.php" method="POST">
                              <tr>
                                 <td>Yearly Rent :<input type="number" class="form-control" name="rent" value="<?php echo $t['fee']; ?>" /><input type="hidden" name="fid" value="<?php echo $t['fee_id'] ?>" /></td>
