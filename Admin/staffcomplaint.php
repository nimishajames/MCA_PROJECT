                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="additional_page">
                           <li>
                              <a href="managecom.php"> <span>View hosteller complaint</span></a>
                           </li>
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <?php $sc = mysqli_query($con, "select * from tbl_scomp c,tbl_staff s where c.s_id=s.s_id and  c.status=0");
                     ...
                     <div class="card">
                        <table class="table">
                           ...
                           <?php
                           while ($re = mysqli_fetch_array($sc)) {
                           ?>
                              <tr>
                                 <td><?php echo $re['s_name'] ?></td>
                                 <td><?php echo $re['scomp'] ?></td>
                                 <td><a class="btn btn-primary" href=" mailto:<?php echo $re['s_email']  ?>">Accept</a></td>
                                 <td><a class="btn btn-danger" href="updates.php?scoid=<?php echo $rm['scomp_id']; ?>">ignore</a></td>
                              </tr>
                           <?php
                           }
                           ?>
