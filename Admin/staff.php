...
?>
                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h4><b>Add Staff</b></h4>
                              <div class="card">
                                 <form name="myform" method="POST" action="staff.php" enctype="multipart/form-data" class="col-8 was-validated">
   ...
   if (isset($_POST['button'])) {
      ...
      if (mysqli_num_rows($wr) <= 0) {
         if (mysqli_query($con, "insert into tbl_login(username,password,status,usertype_id)values('$username','$password','1','4')")) {
            $lg = $con->insert_id;
            if (mysqli_query($con, "insert into tbl_staff(s_name,s_address,s_phone,s_dob,s_email,s_pic,login_id)values('$name','$address','$phone','$dob','$email','$filename','$lg')")) {
