...
?>
            ...
            <div id="content">
               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <form method="POST" action="catroom.php">
                        <?php
                        $r = mysqli_query($con, "select * from tbl_roomtype");
                        ?>
                        <div class="form-group">
                           <label for="exampleInputPassword1">Room Type</label>
                           <input type="text" class="form-control" name="room" id="exampleInputPassword1" placeholder="enter room type">
                        </div>
                        <div class="form-group">
                           <label for="exampleInputPassword1">Room Rent</label>
                           <input type="number" class="form-control" name="rent" id="exampleInputPassword1" placeholder="enter room type">
                        </div>
                     ...
                     <div class="card">
                        <table class="table">
                           ...
                           <?php
                           $sa = mysqli_query($con, "select * from  tbl_roomtype");
                           while ($t = mysqli_fetch_array($sa)) {
                           ?>
                              <tr>
                                 <td><?php echo $t['roomtype']; ?></td>
                                 <td><?php echo $t['room_rent']; ?></td>
                                 <td><a class="btn btn-primary" href="rentupdate.php?rid=<?php echo $t['roomtype_id'] ?>">Update</a></td>
                              </tr>
                           <?php
   ...
   if (isset($_POST['submit'])) {
      $room = $_POST['room'];
      $rent = $_POST['rent'];
      if (mysqli_query($con, "insert into tbl_roomtype(roomtype,room_rent)values('$room','$rent')")) {
         if (headers_sent()) {
